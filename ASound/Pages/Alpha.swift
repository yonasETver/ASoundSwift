    ...
    private var keybordViewBottom: some View{
        HStack{
            ...
            if(language){
                Button{
                    alphaPrint = "ፐ"
                    subLetterAmharic[0] = "ፐ"
                    subLetterAmharic[1] = "ፑ"
                    subLetterAmharic[2] = "ፒ"
                    subLetterAmharic[3] = "ፓ"
                    subLetterAmharic[4] = "ፔ"
                    subLetterAmharic[5] = "ፕ"
                    subLetterAmharic[6] = "ፖ"
                } label:{
                    Text("ፐ")
                        .frame(width: 42, height: 50)
                        .foregroundColor(.black)
            ...
            Button{
                ...
                Text(language ? "AMH" : "ENG")
                    .frame(width: language ? 110 : 115)
                    .frame(height: language ? 50 : 30)
                    .padding(language ? 0 : 17)
                    .foregroundColor(.black)
                    .font(.title)
